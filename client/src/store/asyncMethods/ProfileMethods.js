...
export const updateAboutAction = (user) => {
    return async (dispatch, getState) => {
        ...
        dispatch({ type: SET_LOADER });
        try {
            const { data } = await axios.post('/updateabout', user, config);
            dispatch({ type: CLOSE_LOADER });
            // localStorage.setItem('myToken', data.token);
            // dispatch({ type: SET_TOKEN, payload: data.token });
            dispatch({ type: REDIRECT_TRUE });
...
export const updateEmailAction = (user) => {
    return async (dispatch, getState) => {
        ...
        dispatch({ type: SET_LOADER });
        try {
            const { data } = await axios.post('/updateemail', user, config);
            dispatch({ type: CLOSE_LOADER });
            localStorage.setItem('myToken', data.token);
            dispatch({ type: SET_TOKEN, payload: data.token });
            dispatch({ type: SET_MESSAGE, payload: data.msg });
...
export const updateUsernameAction = (user) => {
    return async (dispatch, getState) => {
        ...
        dispatch({ type: SET_LOADER });
        try {
            const { data } = await axios.post('/updateusername', user, config);
            dispatch({ type: CLOSE_LOADER });
            localStorage.setItem('myToken', data.token);
            dispatch({ type: SET_TOKEN, payload: data.token });
            dispatch({ type: SET_MESSAGE, payload: data.msg });
...
export const updateProfessionAction = (user) => {
    return async (dispatch, getState) => {
        ...
        dispatch({ type: SET_LOADER });
        try {
            const { data } = await axios.post('/updateprofession', user, config);
            dispatch({ type: CLOSE_LOADER });
            localStorage.setItem('myToken', data.token);
            dispatch({ type: SET_TOKEN, payload: data.token });
            dispatch({ type: SET_MESSAGE, payload: data.msg });
...
export const updatePhoneAction = (user) => {
    return async (dispatch, getState) => {
        ...
        dispatch({ type: SET_LOADER });
        try {
            const { data } = await axios.post('/updatephone', user, config);
            dispatch({ type: CLOSE_LOADER });
            localStorage.setItem('myToken', data.token);
            dispatch({ type: SET_TOKEN, payload: data.token });
            dispatch({ type: SET_MESSAGE, payload: data.msg });
...
export const updateAgeAction = (user) => {
    return async (dispatch, getState) => {
        ...
        dispatch({ type: SET_LOADER });
        try {
            const { data } = await axios.post('/updateage', user, config);
            dispatch({ type: CLOSE_LOADER });
            localStorage.setItem('myToken', data.token);
            dispatch({ type: SET_TOKEN, payload: data.token });
            dispatch({ type: SET_MESSAGE, payload: data.msg });
